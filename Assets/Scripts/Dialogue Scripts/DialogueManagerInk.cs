...
public class DialogueManagerInk : MonoBehaviour
{
    ...
    public bool dialogueIsPlaying { get; private set; } // makes it readable-only to outside scripts

    private bool canContinueToNextLine = false;

    private bool submitButtonPressedThisFrame = false; // to fix bug where submit button was not read properly
    ...
    private IEnumerator DisplayLine(string line)
    {
        ...
        // hide icons while text is typing
        ...
        {
            // if the submit button is pressed, finish displaying the line immediately
            if (submitButtonPressedThisFrame)
            {
                submitButtonPressedThisFrame = false; // set to false so the input only happens once
        ...
        // show choices, if any, for this dialogue line
        DisplayChoices();
